...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PalTrade — Forex Analysis & AI Mentor for New Traders" },
      { name: "description", content: "Learn forex trading from zero. Live-style market analysis, beginner classes, and an AI mentor that guides every trade." },
